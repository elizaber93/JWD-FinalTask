...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
   ...
   <jsp:useBean id="userDetail" class="by.epam.training.javaWEB.finalTask.bean.UserDetail" />
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="htc__login__register__wrap">
							...
							<c:set var = "detail" scope = "request" value="${requestScope.userDetail}"/>
								 
                            <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                                <form id= "log_form" action="Controller" class="login" method="post">
									<input type="hidden" name="command" value="edit_profile"/>
									<p>${firstname}</p>
                                    <input type="text" name="firstname" placeholder="${detail.firstname}">
                                    <p>${lastname}</p>
