                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Add article</h2>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <ul class="login__register__menu" role="tablist">
                            <li role="presentation" class="register"><a href="#" role="tab" data-toggle="tab">Add article</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="htc__login__register__wrap">
                            ...
                            <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                                <form id= "article_form" action="Controller" class="login" method="post">
                               ...
                               <div class="htc__login__btn mt--30">
                                    <a href="#" onclick="document.getElementById('article_form').submit();return false" >Add</a>
                                </div>
